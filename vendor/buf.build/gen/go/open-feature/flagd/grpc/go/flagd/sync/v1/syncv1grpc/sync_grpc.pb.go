...
type FlagSyncServiceClient interface {
	SyncFlags(ctx context.Context, in *v1.SyncFlagsRequest, opts ...grpc.CallOption) (FlagSyncService_SyncFlagsClient, error)
...
func (c *flagSyncServiceClient) SyncFlags(ctx context.Context, in *v1.SyncFlagsRequest, opts ...grpc.CallOption) (FlagSyncService_SyncFlagsClient, error) {
...
type FlagSyncService_SyncFlagsClient interface {
	Recv() (*v1.SyncFlagsResponse, error)
	grpc.ClientStream
}
...
func (x *flagSyncServiceSyncFlagsClient) Recv() (*v1.SyncFlagsResponse, error) {
	m := new(v1.SyncFlagsResponse)
...
type FlagSyncServiceServer interface {
	SyncFlags(*v1.SyncFlagsRequest, FlagSyncService_SyncFlagsServer) error
...
// UnimplementedFlagSyncServiceServer should be embedded to have forward compatible implementations.
type UnimplementedFlagSyncServiceServer struct {
}

func (UnimplementedFlagSyncServiceServer) SyncFlags(*v1.SyncFlagsRequest, FlagSyncService_SyncFlagsServer) error {
...
type FlagSyncService_SyncFlagsServer interface {
	Send(*v1.SyncFlagsResponse) error
	grpc.ServerStream
}
...
func (x *flagSyncServiceSyncFlagsServer) Send(m *v1.SyncFlagsResponse) error {
